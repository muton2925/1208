  ...
  <Table :column="th_list" :entrie="td_list" @update="updateData">
    ...
    <template v-slot:table-td>
      <tr v-for="item in filterEntries" :key="item.name">
        ...
        <td class="w-0">
          <div class="d-flex justify-content-center align-items-center text-white bg-warning rounded-circle cursor-pointer mx-auto" style="width:30px; height:30px" data-bs-toggle="modal" data-bs-target="#update_plugin_Modal">
    ...
    <Modalupdate>
      ...
      <template v-slot:body>
        <form>
          <div class="mb-3">
            <label for="InputFile" class="form-label">Plugin Name :</label>
            <input type="text" class="form-control" id="InputFile" placeholder="請輸入 Plugin 名稱" readonly>
          </div>
          <div class="mb-2">
            <label for="UploadFile" class="form-label">Plugin File :</label>
            <input type="file" class="form-control" id="UploadFile">
