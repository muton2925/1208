<template>
  <div class="container-outer" style="overflow:hidden">
    <containerHeader title="Virtualized Network Function Template" btnContent="Create VNF Template"></containerHeader>
    <fileTable title="VNF Template List" :tableFile="th_list"></fileTable>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Create new VNF Template</h5>
