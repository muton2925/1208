<template>
  <div class="container-outer" style="overflow:hidden">
    <containerHeader title="Network Service Descriptor Template" btnContent="Create NSD Template"></containerHeader>
    <fileTable title="NSD Template List" :tableFile="th_list"></fileTable>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Create new NSD Template</h5>
        ...
        <div class="modal-body mx-1">
          <form>
            ...
            <div class="mb-2">
              ...
              <input type="text" class="form-control" id="InputFile2" placeholder="NSD Description">
            </div>
            <div class="mb-2">
...
export default {
  ...
  data() {
    return {
      th_list :['Id', 'Template Name', 'Description', 'Type',	'NFVO',	'NSD Status', 'VNF List',	'Update Template',	'Template Download',	'Delete Template']
    }
  }
}
</script>
